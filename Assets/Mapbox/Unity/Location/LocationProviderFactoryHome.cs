...
namespace Mapbox.Unity.Location
{
	...
	/// </summary>
	public class LocationProviderFactoryHome : MonoBehaviour
	{
		[SerializeField]
		...
		/// </summary>
		private static LocationProviderFactoryHome _instance;
		public static LocationProviderFactoryHome Instance
		{
			get
			{
				return _instance;
