...
namespace HoloToolkit.Unity.InputModule
{
    ...
    /// </summary>
    public class HandDraggableVariation : MonoBehaviour, IFocusable, IInputHandler, ISourceStateHandler
    {
        /// <summary>
        ...
        private bool firstPossition = true;
        private void Start()
        {
        ...
        public void StartDragging(Vector3 initialDraggingPosition)
        {
            ...
            draggingPosition = initialPossition;
        ...
        public void OnInputDown(InputEventData eventData)
        {
            ...
            Vector3 initialDraggingPosition = (details == null)
                ...
                : details.Value.Point;
            if (firstPossition)
                initialPossition = initialDraggingPosition;
            StartDragging(initialPossition);
        }
